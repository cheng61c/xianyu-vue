  ...
  <div v-if="!loading && panelInfo" class="flex flex-col gap-4">
    ...
    <Card>
      <div class="flex flex-wrap">
        <EChartsWrapper :option="panelInfo.recentLoginStats.chart" />
        <EChartsWrapper :option="panelInfo.recentRegisterStats.chart" />
        <EChartsWrapper :option="panelInfo.recentPostStats.chart" />
        <EChartsWrapper :option="panelInfo.recentResourcePostStats.chart" />
        <EChartsWrapper :option="panelInfo.recentCommentStats.chart" />
      </div>
    </Card>
  </div>
</template>
